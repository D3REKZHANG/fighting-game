...
Celsius::Celsius(Game* game, InputReader* inputReader): Player(game, inputReader) {
  ...
  anim["run"] = new Animation(assets()->ss["celsius"], 1, 1, 8, true);
  ...
  move["light"] = new MoveState(this, anim["thrust"], {
...
Naruto::Naruto(Game* game, InputReader* inputReader): Player(game, inputReader) {
  ...
  anim["idle"] = new Animation(assets()->ss["naruto"], 1, 4, 16, true);
  anim["run"] = new Animation(assets()->ss["naruto"], 5, 12, 8, true);
